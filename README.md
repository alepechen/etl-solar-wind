...
The project implements an ETL (Extract, Transform, Load) client that interacts with several local API endpoints. It supports configurable output formats and allows data to be processed across a specified date range.
